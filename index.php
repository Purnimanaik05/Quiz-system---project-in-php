...
function validateForm() {
  ...
  if (br == "") {
    document.getElementById("errormsg").innerHTML="College must be filled";
    return false;
  }
var x = document.forms["form"]["email"].value;var atpos = x.indexOf("@");var dotpos = x.lastIndexOf(".");
if(atpos<1 || dotpos<atpos+2 || dotpos+2>=x.length){
    document.getElementById("errormsg").innerHTML="Not a valid e-mail address";
    return false;
}
  if (m.length < 10) {
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <div id="errormsg" style="font-size:14px;font-family:Times New Roman;font-weight:normal;color:red"><?php
if (@$_GET['q7']) 
{
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="college" name="college" placeholder="Enter your College" class="form-control input-md" type="text" value="<?php
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="email" name="phno" placeholder="Enter your e-mail id" class="form-control input-md" type="text" value="<?php
if (isset($_GET['email']))
{
echo $_GET['email'];
}
